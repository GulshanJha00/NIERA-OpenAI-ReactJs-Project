...
<hr />
      ...
      <div className="w-full md:w-2/3 m-auto  rounded bg-black my-1 text-white h-[450px] overflow-scroll ">
      ...
      <div className="h-screen p-3 bg-slate-800 ">
        <form
          ...
          className="w-full md:w-2/3 m-auto text-center rounded py-2 flex gap-4 mt-16 "
          >
          <textarea
            required
            className="border rounded w-11/12 my-2 min-h-fit p-3 h-16"
            value={question}
